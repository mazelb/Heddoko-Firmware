...
drv_gpio_config_t gpioConfig[] = 
{
	...
	#else
	{DRV_GPIO_ID_PIN_JC_OC1,	DRV_GPIO_PIN_MODE_INPUT,  DRV_GPIO_PIN_STATE_LOW, DRV_GPIO_INTERRUPT_NONE,	   NULL,				TRUE,	TRUE,			0,	DRV_GPIO_PIN_STATE_LOW},
	{DRV_GPIO_ID_PIN_JC_OC2,	DRV_GPIO_PIN_MODE_INPUT,  DRV_GPIO_PIN_STATE_LOW, DRV_GPIO_INTERRUPT_NONE,	   NULL,				TRUE,	TRUE,			0,	DRV_GPIO_PIN_STATE_LOW},
	{DRV_GPIO_ID_PIN_JC_DC1,	DRV_GPIO_PIN_MODE_INPUT,  DRV_GPIO_PIN_STATE_LOW, DRV_GPIO_INTERRUPT_NONE,	   NULL,				FALSE,	TRUE,			0,	DRV_GPIO_PIN_STATE_LOW},
	{DRV_GPIO_ID_PIN_JC_DC2,	DRV_GPIO_PIN_MODE_INPUT,  DRV_GPIO_PIN_STATE_LOW, DRV_GPIO_INTERRUPT_NONE,	   NULL,				FALSE,	TRUE,			0,	DRV_GPIO_PIN_STATE_LOW},
	#endif
	...
	{DRV_GPIO_ID_PIN_BT_PWR_EN,	DRV_GPIO_PIN_MODE_OUTPUT, DRV_GPIO_PIN_STATE_HIGH, DRV_GPIO_INTERRUPT_NONE    , NULL,				FALSE,	FALSE,			0,	DRV_GPIO_PIN_STATE_LOW},
	{DRV_GPIO_ID_PIN_STAT,		DRV_GPIO_PIN_MODE_OUTPUT, DRV_GPIO_PIN_STATE_HIGH, DRV_GPIO_INTERRUPT_NONE,   NULL,					FALSE,	FALSE,			0,	DRV_GPIO_PIN_STATE_HIGH}
