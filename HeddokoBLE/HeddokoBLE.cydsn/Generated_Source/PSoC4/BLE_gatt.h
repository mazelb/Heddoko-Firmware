...
#define CYBLE_GATT_DB_INDEX_COUNT                    (0x0062u)
#define CYBLE_GATT_DB_ATT_VAL_COUNT                  (0x4Eu)
#define CYBLE_GATT_DB_MAX_VALUE_LEN                  (0x0080u)
...
extern const uint8 cyBle_attUuid128[21u][16u];
