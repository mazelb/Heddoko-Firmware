...
const CYBLE_CUSTOMS_T cyBle_customs[0x06u] = {
    ...
    {
        0x0026u, /* Handle of the Heddoko: Raw data service */ 
        {

            /* Raw data characteristic */
            {
                0x0028u, /* Handle of the Raw data characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0029u, /* Handle of the Characteristic User Description descriptor */ 
                    0x002Au, /* Handle of the Client Characteristic Configuration descriptor */ 
                }, 
            },
            {
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, 
    ...
    {
        0x002Bu, /* Handle of the Heddoko: BrainPack Status service */ 
        {

            /* BP-Status characteristic */
            {
                0x002Du, /* Handle of the BP-Status characteristic */ 
            ...
            {
                0x0031u, /* Handle of the Sensor Mask characteristic */ 
    ...
    {
        0x004Bu, /* Handle of the Heddoko: Recording Control service */ 
        {

            /* Recording State characteristic */
            {
                0x004Du, /* Handle of the Recording State characteristic */ 
            ...
            {
                0x0051u, /* Handle of the Recording Request characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0052u, /* Handle of the Recording Request descriptor */ 
