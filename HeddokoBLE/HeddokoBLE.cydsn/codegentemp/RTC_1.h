...
#define RTC_1_INITIAL_DATA_FORMAT     (1u)
#define RTC_1_INITIAL_TIME_FORMAT     (0u)
#define RTC_1_INITIAL_UPDATE_MODE     (1u)
#define RTC_1_INITIAL_SECOND          (3u)
#define RTC_1_INITIAL_MINUTE          (2u)
#define RTC_1_INITIAL_HOUR            (1u)
#define RTC_1_INITIAL_DAY             (4u)
#define RTC_1_INITIAL_MONTH           (5u)
#define RTC_1_INITIAL_YEAR            (2017u)

#define RTC_1_INITIAL_ALARM_STATUS    (0u)

#define RTC_1_INITIAL_DST_STATUS      (0u)
#define RTC_1_INITIAL_DST_DATE_TYPE   (1u)
