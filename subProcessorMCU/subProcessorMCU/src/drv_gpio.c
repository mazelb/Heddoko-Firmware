...
drv_gpio_config_t gpioConfig[] = 
{
	...
	{DRV_GPIO_ID_PIN_JC_EN1,	  DRV_GPIO_PIN_MODE_INPUT,  DRV_GPIO_PIN_STATE_HIGH, DRV_GPIO_INTERRUPT_NONE,		NULL,			TRUE,	TRUE,			0,	DRV_GPIO_PIN_STATE_HIGH},
	{DRV_GPIO_ID_PIN_JC1_DET,	  DRV_GPIO_PIN_MODE_INPUT,   DRV_GPIO_PIN_STATE_LOW, DRV_GPIO_INTERRUPT_LOW_EDGE,  drv_gpio_int_dc1,FALSE,	TRUE,			0,	DRV_GPIO_PIN_STATE_LOW},
	{DRV_GPIO_ID_PIN_JC2_DET,	  DRV_GPIO_PIN_MODE_INPUT,   DRV_GPIO_PIN_STATE_LOW, DRV_GPIO_INTERRUPT_LOW_EDGE,  drv_gpio_int_dc2,FALSE,	TRUE,			0,	DRV_GPIO_PIN_STATE_LOW},
	...
	{DRV_GPIO_ID_PIN_RS485,		  DRV_GPIO_PIN_MODE_OUTPUT,  DRV_GPIO_PIN_STATE_LOW, DRV_GPIO_INTERRUPT_NONE	 ,	NULL,			TRUE,	TRUE,			0,	DRV_GPIO_PIN_STATE_HIGH},
	...
	{DRV_GPIO_ID_PIN_RS485_D_EN,  DRV_GPIO_PIN_MODE_OUTPUT,  DRV_GPIO_PIN_STATE_HIGH, DRV_GPIO_INTERRUPT_NONE    ,	NULL,			FALSE,	FALSE,			0,	DRV_GPIO_PIN_STATE_HIGH},
	{DRV_GPIO_ID_PIN_RS485_R_EN,  DRV_GPIO_PIN_MODE_OUTPUT,  DRV_GPIO_PIN_STATE_HIGH, DRV_GPIO_INTERRUPT_NONE    ,	NULL,			FALSE,	FALSE,			0,	DRV_GPIO_PIN_STATE_HIGH}
...
status_t drv_gpio_initializeAll(void)
{
	...
	int i = 0; 
	//Change the PB4 to be configured as GPIO and not TDI
